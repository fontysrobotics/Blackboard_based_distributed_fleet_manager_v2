...
#include "move_base_msgs/action/detail/move_base__rosidl_typesupport_fastrtps_c.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_move_base_msgs
...
using _MoveBase_Goal__ros_msg_type = move_base_msgs__action__MoveBase_Goal;
...
static uint32_t _MoveBase_Goal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_move_base_msgs__action__MoveBase_Goal(
...
{
  return max_serialized_size_move_base_msgs__action__MoveBase_Goal(
    full_bounded, 0);
}
...
using _MoveBase_Result__ros_msg_type = move_base_msgs__action__MoveBase_Result;
...
{
  return static_cast<uint32_t>(
    get_serialized_size_move_base_msgs__action__MoveBase_Result(
      untyped_ros_message, 0));
}
...
{
  return max_serialized_size_move_base_msgs__action__MoveBase_Result(
    full_bounded, 0);
}
...
// already included above
// #include "geometry_msgs/msg/detail/pose_stamped__functions.h"  // base_position
...
using _MoveBase_Feedback__ros_msg_type = move_base_msgs__action__MoveBase_Feedback;
...
{
  return static_cast<uint32_t>(
    get_serialized_size_move_base_msgs__action__MoveBase_Feedback(
      untyped_ros_message, 0));
}
...
{
  return max_serialized_size_move_base_msgs__action__MoveBase_Feedback(
    full_bounded, 0);
}
...
// already included above
// #include "move_base_msgs/action/detail/move_base__functions.h"  // goal
...
using _MoveBase_SendGoal_Request__ros_msg_type = move_base_msgs__action__MoveBase_SendGoal_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: goal
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, move_base_msgs, action, MoveBase_Goal
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_move_base_msgs__action__MoveBase_Goal(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_move_base_msgs__action__MoveBase_SendGoal_Request(
      untyped_ros_message, 0));
}
  ...
  size_t current_alignment)
{
  ...
  // member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_move_base_msgs__action__MoveBase_Goal(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_move_base_msgs__action__MoveBase_SendGoal_Request(
    full_bounded, 0);
}
...
using _MoveBase_SendGoal_Response__ros_msg_type = move_base_msgs__action__MoveBase_SendGoal_Response;
...
{
  return static_cast<uint32_t>(
    get_serialized_size_move_base_msgs__action__MoveBase_SendGoal_Response(
      untyped_ros_message, 0));
}
...
{
  return max_serialized_size_move_base_msgs__action__MoveBase_SendGoal_Response(
    full_bounded, 0);
}
...
using _MoveBase_GetResult_Request__ros_msg_type = move_base_msgs__action__MoveBase_GetResult_Request;
...
{
  return static_cast<uint32_t>(
    get_serialized_size_move_base_msgs__action__MoveBase_GetResult_Request(
      untyped_ros_message, 0));
}
...
{
  return max_serialized_size_move_base_msgs__action__MoveBase_GetResult_Request(
    full_bounded, 0);
}
...
// already included above
// #include "move_base_msgs/action/detail/move_base__functions.h"  // result
...
using _MoveBase_GetResult_Response__ros_msg_type = move_base_msgs__action__MoveBase_GetResult_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: result
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, move_base_msgs, action, MoveBase_Result
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_move_base_msgs__action__MoveBase_Result(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_move_base_msgs__action__MoveBase_GetResult_Response(
      untyped_ros_message, 0));
}
  ...
  size_t current_alignment)
{
  ...
  // member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_move_base_msgs__action__MoveBase_Result(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_move_base_msgs__action__MoveBase_GetResult_Response(
    full_bounded, 0);
}
...
// already included above
// #include "move_base_msgs/action/detail/move_base__functions.h"  // feedback
// already included above
// #include "unique_identifier_msgs/msg/detail/uuid__functions.h"  // goal_id
...
using _MoveBase_FeedbackMessage__ros_msg_type = move_base_msgs__action__MoveBase_FeedbackMessage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: feedback
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, move_base_msgs, action, MoveBase_Feedback
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_move_base_msgs__action__MoveBase_Feedback(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_move_base_msgs__action__MoveBase_FeedbackMessage(
      untyped_ros_message, 0));
}
  ...
  size_t current_alignment)
{
  ...
  // member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_move_base_msgs__action__MoveBase_Feedback(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_move_base_msgs__action__MoveBase_FeedbackMessage(
    full_bounded, 0);
}
