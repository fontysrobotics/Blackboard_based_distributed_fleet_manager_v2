...
#ifndef MESSAGE_PKG__MSG__DETAIL__TASK_MSG__STRUCT_HPP_
#define MESSAGE_PKG__MSG__DETAIL__TASK_MSG__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__message_pkg__msg__TaskMsg __attribute__((deprecated))
#else
# define DEPRECATED__message_pkg__msg__TaskMsg __declspec(deprecated)
#endif
...
struct TaskMsg_
{
  ...
  // pointer types
  using RawPtr =
    message_pkg::msg::TaskMsg_<ContainerAllocator> *;
  using ConstRawPtr =
    const message_pkg::msg::TaskMsg_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<message_pkg::msg::TaskMsg_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<message_pkg::msg::TaskMsg_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      message_pkg::msg::TaskMsg_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<message_pkg::msg::TaskMsg_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<message_pkg::msg::TaskMsg_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<message_pkg::msg::TaskMsg_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<message_pkg::msg::TaskMsg_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__message_pkg__msg__TaskMsg
    std::shared_ptr<message_pkg::msg::TaskMsg_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__message_pkg__msg__TaskMsg
    std::shared_ptr<message_pkg::msg::TaskMsg_<ContainerAllocator> const>
...
using TaskMsg =
  message_pkg::msg::TaskMsg_<std::allocator<void>>;
...
#endif  // MESSAGE_PKG__MSG__DETAIL__TASK_MSG__STRUCT_HPP_
