...
bool message_pkg__msg__task_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("message_pkg.msg._task_msg.TaskMsg", full_classname_dest, 33) == 0);
  }
  message_pkg__msg__TaskMsg * ros_message = _ros_message;
  {  // taskid
...
PyObject * message_pkg__msg__task_msg__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("message_pkg.msg._task_msg");
