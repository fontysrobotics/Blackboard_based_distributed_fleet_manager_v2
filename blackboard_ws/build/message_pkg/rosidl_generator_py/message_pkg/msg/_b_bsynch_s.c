...
bool message_pkg__msg__b_bsynch__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("message_pkg.msg._b_bsynch.BBsynch", full_classname_dest, 33) == 0);
  }
  message_pkg__msg__BBsynch * ros_message = _ros_message;
  {  // tasks
...
{
  /* NOTE(esteve): Call constructor of BBsynch */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("message_pkg.msg._b_bsynch");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BBsynch");
