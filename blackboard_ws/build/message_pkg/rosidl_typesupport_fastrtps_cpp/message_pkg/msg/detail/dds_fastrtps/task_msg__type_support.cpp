...
#include "message_pkg/msg/detail/task_msg__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const message_pkg::msg::TaskMsg & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  message_pkg::msg::TaskMsg & ros_message)
{
  // Member: taskid
  cdr >> ros_message.taskid;
...
{
  auto typed_message =
    static_cast<const message_pkg::msg::TaskMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<message_pkg::msg::TaskMsg *>(
    untyped_ros_message);
...
{
  return &message_pkg::msg::typesupport_fastrtps_cpp::_TaskMsg__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, message_pkg, msg, TaskMsg)() {
  return &message_pkg::msg::typesupport_fastrtps_cpp::_TaskMsg__handle;
}
