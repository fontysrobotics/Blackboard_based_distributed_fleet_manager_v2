...
#include "message_pkg/msg/detail/task_msg__rosidl_typesupport_fastrtps_c.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_message_pkg
...
using _TaskMsg__ros_msg_type = message_pkg__msg__TaskMsg;
...
static uint32_t _TaskMsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_message_pkg__msg__TaskMsg(
...
{
  return max_serialized_size_message_pkg__msg__TaskMsg(
    full_bounded, 0);
}
