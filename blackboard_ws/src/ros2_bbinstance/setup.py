...
setup(
    ...
    entry_points={
        ...
        'robotInstance2 = ros2_bbinstance.robotInstance2:main',
        'robotInstance3 = ros2_bbinstance.robotInstance3:main',
        'robotInstance4 = ros2_bbinstance.robotInstance4:main',
