...
odom_frame_id_arg = DeclareLaunchArgument(
    "odom_frame_id", default_value="robot1_tf/odom"
    )
base_frame_id_arg = DeclareLaunchArgument(
    "base_frame_id", default_value="robot1_tf/base_footprint"
)
global_frame_id_arg = DeclareLaunchArgument(
    "global_frame_id", default_value="map"
)
odom_topic_arg = DeclareLaunchArgument(
    "odom_topic", default_value="/robot1/odom"
)
laser_topic_arg = DeclareLaunchArgument(
    "laser_topic", default_value="/robot1/laser/scan"
)
...
def generate_launch_description():
    ld = launch.LaunchDescription([
        launch.actions.DeclareLaunchArgument(
            name='odom_frame_id',
            default_value='robot1_tf/odom'
        ),
        launch.actions.DeclareLaunchArgument(
            name='base_frame_id',
            default_value='robot1_tf/base_footprint'
        ),
        launch.actions.DeclareLaunchArgument(
        ...
        launch.actions.DeclareLaunchArgument(
            name='laser_topic',
            default_value='/robot1/laser/scan'
        ),
        launch.actions.DeclareLaunchArgument(
        ...
        launch_ros.actions.Node(
            ...
            remappings=[
                ...
                ('/move_base/global_costmap/inflation_layer/parameter_descriptions' , '/robot/move_base/global_costmap/inflation_layer/parameter_descriptions'),
                ...
                ('/move_base/global_costmap/obstacle_layer/clearing_endpoints'      , '/robot1/move_base/global_costmap/obstacle_layer/cleraing_endpoints'),
                ('/move_base/global_costmap/obstacle_layer/parameter_descriptions'  , '/robot1/move_base/global_costmap/obstacle_layers/parameter_descriptions'),
                ('/move_base/global_costmap/obstacle_layer/parameter_updates'       , '/robot1/move_base/global_costmap/obstacle_layers/parameter_updates'),
                ('/move_base/global_costmap/parameter_descriptions'                 , '/robot1/move_base/global_costmap/parameter_descriptions'),
